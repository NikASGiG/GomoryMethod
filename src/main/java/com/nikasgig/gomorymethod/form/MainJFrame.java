 ...
 */
package com.nikasgig.gomorymethod.form;

import com.nikasgig.gomorymethod.service.BuildService;
import com.nikasgig.gomorymethod.service.GomoryMethodService;
import com.nikasgig.gomorymethod.service.InputService;
import com.nikasgig.gomorymethod.service.OutputService;
import com.nikasgig.gomorymethod.util.ExportXLS;
...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Gomory Method Application");
        ...
        label8.setText("Table of gomory method");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(label10, javax.swing.GroupLayout.PREFERRED_SIZE, 389, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE))))
        );
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        ...
        boolean isMax = selectedValue.equals("max");

        GomoryMethodService gomoryMethodService = new GomoryMethodService(frame);
        Object[] gomoryResult = gomoryMethodService.gomoryMethod(inputService.getA(), inputService.getB(), inputService.getC(), isMax);
        System.out.println("get result");
        System.out.println("+++++");

        if (gomoryResult == null) {
            System.out.println("Unbounded solution");
        } else {
            double[][] solution = (double[][]) gomoryResult[0];
            System.out.println("Solution:");
            for (int i = 0; i < solution.length; i++) {
                System.out.println("x" + (i + 1) + " = " + solution[i][solution[i].length - 1]);
            }
        }
        System.out.println("+++++");
        //gomoryResult = gomoryMethodService.gomoryMethod(inputService.getA(), inputService.getB(), inputService.getC(), isMax);
        System.out.println("show result");
        Map<String, Object> extractResults = gomoryMethodService.extractResults(gomoryResult);
        System.out.println("get extractResults");
        double[][] solutionFromExtractResults = (double[][]) extractResults.get("table");
        OutputService.showResult(frame, solutionFromExtractResults);
        System.out.println("end of showResult");
        } catch(Exception ex){
            frame.label10.setText("Error! This problem has no solution");
            return;
        }
        frame.label10.setText("This problem has a solution");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                System.out.println("Welcome to Gomory Method Application");
            }
        });
    }
